-- CreateEnum
CREATE TYPE "ticket_status" AS ENUM ('pending', 'in_progress', 'resolved', 'rejected', 'duplicate', 'canceled');
...
CREATE TABLE "tickets" (
    ...
    "created_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(6) NOT NULL,
    "timestamp_inprogress" TIMESTAMP(6),
...
-- CreateIndex
CREATE INDEX "ticket_title_trgm_idx" ON "tickets" USING GIN ("title" gin_trgm_ops);

-- CreateIndex
CREATE INDEX "ticket_desc_trgm_idx" ON "tickets" USING GIN ("description" gin_trgm_ops);
